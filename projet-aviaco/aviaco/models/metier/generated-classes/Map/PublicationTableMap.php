...
class PublicationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.PublicationTableMap';
     ...
     */
    const CLASS_DEFAULT = 'Publication';
     ...
     */
    const COL_DATE_PUB = 'publication.date_pub';

    /**
     * the column name for the etat field
     */
    const COL_ETAT = 'publication.etat';

    /**
     * the column name for the slider field
     */
    const COL_SLIDER = 'publication.slider';

    /**
     * the column name for the art_num_PK field
     */
    const COL_ART_NUM_PK = 'publication.art_num_PK';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('ID', 'Datepublication', 'Etat', 'isSlider', 'Art_num_PK', ),
        self::TYPE_CAMELNAME     => array('iD', 'datepublication', 'etat', 'isSlider', 'art_num_PK', ),
        self::TYPE_COLNAME       => array(PublicationTableMap::COL_ID, PublicationTableMap::COL_DATE_PUB, PublicationTableMap::COL_ETAT, PublicationTableMap::COL_SLIDER, PublicationTableMap::COL_ART_NUM_PK, ),
        self::TYPE_FIELDNAME     => array('id', 'date_pub', 'etat', 'slider', 'art_num_PK', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('ID' => 0, 'Datepublication' => 1, 'Etat' => 2, 'isSlider' => 3, 'Art_num_PK' => 4, ),
        self::TYPE_CAMELNAME     => array('iD' => 0, 'datepublication' => 1, 'etat' => 2, 'isSlider' => 3, 'art_num_PK' => 4, ),
        self::TYPE_COLNAME       => array(PublicationTableMap::COL_ID => 0, PublicationTableMap::COL_DATE_PUB => 1, PublicationTableMap::COL_ETAT => 2, PublicationTableMap::COL_SLIDER => 3, PublicationTableMap::COL_ART_NUM_PK => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'date_pub' => 1, 'etat' => 2, 'slider' => 3, 'art_num_PK' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('date_pub', 'Datepublication', 'TIMESTAMP', false, null, null);
        $this->addColumn('etat', 'Etat', 'BOOLEAN', false, 1, null);
        $this->addColumn('slider', 'isSlider', 'BOOLEAN', false, 1, null);
        $this->addForeignKey('art_num_PK', 'Art_num_PK', 'INTEGER', 'article', 'art_num', false, null, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PublicationTableMap::COL_DATE_PUB);
            $criteria->addSelectColumn(PublicationTableMap::COL_ETAT);
            $criteria->addSelectColumn(PublicationTableMap::COL_SLIDER);
            $criteria->addSelectColumn(PublicationTableMap::COL_ART_NUM_PK);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.date_pub');
            $criteria->addSelectColumn($alias . '.etat');
            $criteria->addSelectColumn($alias . '.slider');
            $criteria->addSelectColumn($alias . '.art_num_PK');
        }
    }
