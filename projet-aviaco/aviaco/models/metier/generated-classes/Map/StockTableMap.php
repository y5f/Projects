...
class StockTableMap extends TableMap
{
    ...
    /**
     * the column name for the date_arrivee field
     */
    const COL_DATE_ARRIVEE = 'stock.date_arrivee';

    /**
     * the column name for the date_depart field
     */
    const COL_DATE_DEPART = 'stock.date_depart';

    /**
     * the column name for the reference_PK field
     */
    const COL_REFERENCE_PK = 'stock.reference_PK';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id_stock', 'Datearrivee', 'Datedepart', 'Reference_PK', ),
        self::TYPE_CAMELNAME     => array('id_stock', 'datearrivee', 'datedepart', 'reference_PK', ),
        self::TYPE_COLNAME       => array(StockTableMap::COL_STOCK_ID, StockTableMap::COL_DATE_ARRIVEE, StockTableMap::COL_DATE_DEPART, StockTableMap::COL_REFERENCE_PK, ),
        self::TYPE_FIELDNAME     => array('stock_id', 'date_arrivee', 'date_depart', 'reference_PK', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id_stock' => 0, 'Datearrivee' => 1, 'Datedepart' => 2, 'Reference_PK' => 3, ),
        self::TYPE_CAMELNAME     => array('id_stock' => 0, 'datearrivee' => 1, 'datedepart' => 2, 'reference_PK' => 3, ),
        self::TYPE_COLNAME       => array(StockTableMap::COL_STOCK_ID => 0, StockTableMap::COL_DATE_ARRIVEE => 1, StockTableMap::COL_DATE_DEPART => 2, StockTableMap::COL_REFERENCE_PK => 3, ),
        self::TYPE_FIELDNAME     => array('stock_id' => 0, 'date_arrivee' => 1, 'date_depart' => 2, 'reference_PK' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('stock_id', 'Id_stock', 'INTEGER', true, null, null);
        $this->addColumn('date_arrivee', 'Datearrivee', 'TIMESTAMP', false, null, null);
        $this->addColumn('date_depart', 'Datedepart', 'TIMESTAMP', false, null, null);
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to stock     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Id_stock', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Id_stock', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('Id_stock', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(StockTableMap::COL_DATE_ARRIVEE);
            $criteria->addSelectColumn(StockTableMap::COL_DATE_DEPART);
            $criteria->addSelectColumn(StockTableMap::COL_REFERENCE_PK);
        } else {
            $criteria->addSelectColumn($alias . '.stock_id');
            $criteria->addSelectColumn($alias . '.date_arrivee');
