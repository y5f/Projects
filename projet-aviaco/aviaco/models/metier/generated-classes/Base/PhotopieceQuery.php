 ...
 * @method     ChildPhotopieceQuery orderByReference_FK($order = Criteria::ASC) Order by the reference_FK column
 *
 ...
 * @method     ChildPhotopieceQuery groupByReference_FK() Group by the reference_FK column
 *
 ...
 *
 * @method     ChildPhotopieceQuery leftJoinPiece($relationAlias = null) Adds a LEFT JOIN clause to the query using the Piece relation
 * @method     ChildPhotopieceQuery rightJoinPiece($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Piece relation
 * @method     ChildPhotopieceQuery innerJoinPiece($relationAlias = null) Adds a INNER JOIN clause to the query using the Piece relation
 *
 ...
 * @method     ChildPhotopiece findOneByReference_FK(string $reference_FK) Return the first ChildPhotopiece filtered by the reference_FK column *
 ...
 * @method     ChildPhotopiece requireOneByReference_FK(string $reference_FK) Return the first ChildPhotopiece filtered by the reference_FK column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPhotopiece[]|ObjectCollection findByReference_FK(string $reference_FK) Return ChildPhotopiece objects filtered by the reference_FK column
...
abstract class PhotopieceQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'aviaco', $modelName = '\\Photopiece', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, url_photo, date_photo, titre_photo, commentaire, reference_FK FROM photo_piece WHERE id = :p0';
        try {
    ...
    public function filterByReference_FK($reference_FK = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PhotopieceTableMap::COL_REFERENCE_FK, $reference_FK, $comparison);
    }
    ...
    public function filterByPiece($piece, $comparison = null)
    {
        if ($piece instanceof \Piece) {
            return $this
                ->addUsingAlias(PhotopieceTableMap::COL_REFERENCE_FK, $piece->getReference(), $comparison);
            ...
            return $this
                ->addUsingAlias(PhotopieceTableMap::COL_REFERENCE_FK, $piece->toKeyValue('Reference', 'Reference'), $comparison);
        } else {
