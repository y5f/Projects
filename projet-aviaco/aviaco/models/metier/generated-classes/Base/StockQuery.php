 ...
 * @method     ChildStockQuery orderByDatearrivee($order = Criteria::ASC) Order by the date_arrivee column
 * @method     ChildStockQuery orderByDatedepart($order = Criteria::ASC) Order by the date_depart column
 * @method     ChildStockQuery orderByReference_PK($order = Criteria::ASC) Order by the reference_PK column
 *
 * @method     ChildStockQuery groupById_stock() Group by the stock_id column
 * @method     ChildStockQuery groupByDatearrivee() Group by the date_arrivee column
 * @method     ChildStockQuery groupByDatedepart() Group by the date_depart column
 * @method     ChildStockQuery groupByReference_PK() Group by the reference_PK column
 *
 ...
 *
 * @method     ChildStockQuery leftJoinStockdepot($relationAlias = null) Adds a LEFT JOIN clause to the query using the Stockdepot relation
 * @method     ChildStockQuery rightJoinStockdepot($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Stockdepot relation
 * @method     ChildStockQuery innerJoinStockdepot($relationAlias = null) Adds a INNER JOIN clause to the query using the Stockdepot relation
 *
 * @method     \PieceQuery|\StockdepotQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildStock findOneByDatearrivee(string $date_arrivee) Return the first ChildStock filtered by the date_arrivee column
 * @method     ChildStock findOneByDatedepart(string $date_depart) Return the first ChildStock filtered by the date_depart column
 * @method     ChildStock findOneByReference_PK(string $reference_PK) Return the first ChildStock filtered by the reference_PK column *
 ...
 * @method     ChildStock requireOneByDatearrivee(string $date_arrivee) Return the first ChildStock filtered by the date_arrivee column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildStock requireOneByReference_PK(string $reference_PK) Return the first ChildStock filtered by the reference_PK column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildStock[]|ObjectCollection findByDatearrivee(string $date_arrivee) Return ChildStock objects filtered by the date_arrivee column
 ...
 * @method     ChildStock[]|ObjectCollection findByReference_PK(string $reference_PK) Return ChildStock objects filtered by the reference_PK column
...
abstract class StockQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'aviaco', $modelName = '\\Stock', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT stock_id, date_arrivee, date_depart, reference_PK FROM stock WHERE stock_id = :p0';
        try {
    ...
    /**
     * Filter the query on the date_arrivee column
     *
     * Example usage:
     * <code>
     * $query->filterByDatearrivee('2011-03-14'); // WHERE date_arrivee = '2011-03-14'
     * $query->filterByDatearrivee('now'); // WHERE date_arrivee = '2011-03-14'
     * $query->filterByDatearrivee(array('max' => 'yesterday')); // WHERE date_arrivee > '2011-03-13'
     * </code>
     *
     * @param     mixed $datearrivee The value to use as filter.
     ...
     * @return $this|ChildStockQuery The current query, for fluid interface
     */
    public function filterByDatearrivee($datearrivee = null, $comparison = null)
    {
        if (is_array($datearrivee)) {
            $useMinMax = false;
            if (isset($datearrivee['min'])) {
                $this->addUsingAlias(StockTableMap::COL_DATE_ARRIVEE, $datearrivee['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($datearrivee['max'])) {
                $this->addUsingAlias(StockTableMap::COL_DATE_ARRIVEE, $datearrivee['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(StockTableMap::COL_DATE_ARRIVEE, $datearrivee, $comparison);
    }
    ...
    public function filterByReference_PK($reference_PK = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(StockTableMap::COL_REFERENCE_PK, $reference_PK, $comparison);
    }
    ...
    public function filterByPiece($piece, $comparison = null)
    {
        if ($piece instanceof \Piece) {
            return $this
                ->addUsingAlias(StockTableMap::COL_REFERENCE_PK, $piece->getReference(), $comparison);
            ...
            return $this
                ->addUsingAlias(StockTableMap::COL_REFERENCE_PK, $piece->toKeyValue('Reference', 'Reference'), $comparison);
        } else {
    ...
    public function filterByStockdepot($stockdepot, $comparison = null)
    {
        if ($stockdepot instanceof \Stockdepot) {
            return $this
                ->addUsingAlias(StockTableMap::COL_STOCK_ID, $stockdepot->getStock_id_PK(), $comparison);
