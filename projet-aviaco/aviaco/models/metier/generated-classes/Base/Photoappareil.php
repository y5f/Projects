...
abstract class Photoappareil implements ActiveRecordInterface
{
    ...
    public function setEtat($v)
    {
        ...
        if ($this->etat !== $v) {
            $this->etat = $v;
            $this->modifiedColumns[PhotoappareilTableMap::COL_ETAT] = true;
        }
    ...
    public function setmodele_PK($v)
    {
        ...
        if ($this->modele_pk !== $v) {
            $this->modele_pk = $v;
            $this->modifiedColumns[PhotoappareilTableMap::COL_MODELE_PK] = true;
        }
    ...
    public function setmarque_PK($v)
    {
        ...
        if ($this->marque_pk !== $v) {
            $this->marque_pk = $v;
            $this->modifiedColumns[PhotoappareilTableMap::COL_MARQUE_PK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PhotoappareilTableMap::translateFieldName('Etat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->etat = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : PhotoappareilTableMap::translateFieldName('IdAp_PK', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idap_pk = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : PhotoappareilTableMap::translateFieldName('modele_PK', TableMap::TYPE_PHPNAME, $indexType)];
            $this->modele_pk = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : PhotoappareilTableMap::translateFieldName('marque_PK', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 9; // 9 = PhotoappareilTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PhotoappareilTableMap::COL_ETAT)) {
            $modifiedColumns[':p' . $index++]  = 'etat';
        }
        if ($this->isColumnModified(PhotoappareilTableMap::COL_IDAP_PK)) {
            $modifiedColumns[':p' . $index++]  = 'idAp_PK';
        }
        if ($this->isColumnModified(PhotoappareilTableMap::COL_MODELE_PK)) {
            $modifiedColumns[':p' . $index++]  = 'modele_PK';
        }
        if ($this->isColumnModified(PhotoappareilTableMap::COL_MARQUE_PK)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[5] => $this->getEtat(),
            $keys[6] => $this->getIdAp_PK(),
            $keys[7] => $this->getmodele_PK(),
            $keys[8] => $this->getmarque_PK(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setIdAp_PK($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setmodele_PK($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setmarque_PK($arr[$keys[8]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PhotoappareilTableMap::COL_ETAT)) {
            $criteria->add(PhotoappareilTableMap::COL_ETAT, $this->etat);
        }
        if ($this->isColumnModified(PhotoappareilTableMap::COL_IDAP_PK)) {
            $criteria->add(PhotoappareilTableMap::COL_IDAP_PK, $this->idap_pk);
        }
        if ($this->isColumnModified(PhotoappareilTableMap::COL_MODELE_PK)) {
            $criteria->add(PhotoappareilTableMap::COL_MODELE_PK, $this->modele_pk);
        }
        if ($this->isColumnModified(PhotoappareilTableMap::COL_MARQUE_PK)) {
            $criteria->add(PhotoappareilTableMap::COL_MARQUE_PK, $this->marque_pk);
        }
    ...
    public function hashCode()
    {
        ...
        //relation photo_appareil_fk_237925 to table appareil
        ...
        //relation photo_appareil_fk_47db7e to table modele
        ...
        //relation photo_appareil_fk_041995 to table marque
    ...
    public function getPrimaryKey()
    {
        $pks = array();
        $pks[0] = $this->getID();
        $pks[1] = $this->getIdAp_PK();
        $pks[2] = $this->getmodele_PK();
        $pks[3] = $this->getmarque_PK();
    ...
    {
        $this->setID($keys[0]);
        $this->setIdAp_PK($keys[1]);
        $this->setmodele_PK($keys[2]);
        $this->setmarque_PK($keys[3]);
    }
    ...
    {
        return (null === $this->getID()) && (null === $this->getIdAp_PK()) && (null === $this->getmodele_PK()) && (null === $this->getmarque_PK());
    }
    ...
    public function getModele(ConnectionInterface $con = null)
    {
        if ($this->aModele === null && (($this->modele_pk !== "" && $this->modele_pk !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aModele->addPhotoappareils($this);
             */
        }
    ...
    public function getMarque(ConnectionInterface $con = null)
    {
        if ($this->aMarque === null && (($this->marque_pk !== "" && $this->marque_pk !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMarque->addPhotoappareils($this);
             */
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aModele) {
            $this->aModele->removePhotoappareil($this);
        }
        if (null !== $this->aMarque) {
            $this->aMarque->removePhotoappareil($this);
        }
        $this->id = null;
        $this->url_photo = null;
