 ...
 *
 * @method     ChildMarqueQuery leftJoinPieceApp($relationAlias = null) Adds a LEFT JOIN clause to the query using the PieceApp relation
 * @method     ChildMarqueQuery rightJoinPieceApp($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PieceApp relation
 * @method     ChildMarqueQuery innerJoinPieceApp($relationAlias = null) Adds a INNER JOIN clause to the query using the PieceApp relation
 *
 * @method     ChildMarqueQuery leftJoinPhotoappareil($relationAlias = null) Adds a LEFT JOIN clause to the query using the Photoappareil relation
 * @method     ChildMarqueQuery rightJoinPhotoappareil($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Photoappareil relation
 * @method     ChildMarqueQuery innerJoinPhotoappareil($relationAlias = null) Adds a INNER JOIN clause to the query using the Photoappareil relation
 *
 * @method     \ModelQuery|\AppareilQuery|\PieceAppQuery|\PhotoappareilQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class MarqueQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'aviaco', $modelName = '\\Marque', $modelAlias = null)
    {
    ...
    public function filterByPieceApp($pieceApp, $comparison = null)
    {
        if ($pieceApp instanceof \PieceApp) {
            return $this
                ->addUsingAlias(MarqueTableMap::COL_MARQUE, $pieceApp->getMarque_PK(), $comparison);
    ...
    public function filterByPhotoappareil($photoappareil, $comparison = null)
    {
        if ($photoappareil instanceof \Photoappareil) {
            return $this
                ->addUsingAlias(MarqueTableMap::COL_MARQUE, $photoappareil->getmarque_PK(), $comparison);
