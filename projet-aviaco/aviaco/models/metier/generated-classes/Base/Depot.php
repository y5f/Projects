...
/**
 * Base class that represents a row from the 'depot' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Depot implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\DepotTableMap';
    ...
    /**
     * The value for the id_depot field.
     * @var        int
     */
    protected $id_depot;

    /**
     * The value for the depot_adresse field.
     * @var        string
     */
    protected $depot_adresse;
    ...
    /**
     * Initializes internal state of Base\Depot object.
     */
    ...
    /**
     * Compares this with another <code>Depot</code> instance.  If
     * <code>obj</code> is an instance of <code>Depot</code>, delegates to
     * <code>equals(Depot)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Depot The current object, for fluid interface
     */
    ...
    /**
     * Get the [depot_adresse] column value.
     *
     * @return string
     */
    public function getDepotAdresse()
    {
        return $this->depot_adresse;
    }

    /**
     * Set the value of [id_depot] column.
     *
     * @param int $v new value
     * @return $this|\Depot The current object (for fluent API support)
     */
    public function setIddepot($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->id_depot !== $v) {
            $this->id_depot = $v;
            $this->modifiedColumns[DepotTableMap::COL_ID_DEPOT] = true;
        }
    ...
    /**
     * Set the value of [depot_adresse] column.
     *
     * @param string $v new value
     * @return $this|\Depot The current object (for fluent API support)
     */
    public function setDepotAdresse($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->depot_adresse !== $v) {
            $this->depot_adresse = $v;
            $this->modifiedColumns[DepotTableMap::COL_DEPOT_ADRESSE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DepotTableMap::translateFieldName('Iddepot', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_depot = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DepotTableMap::translateFieldName('DepotAdresse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->depot_adresse = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = DepotTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Depot'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDepotQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDepotQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DepotTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[DepotTableMap::COL_ID_DEPOT] = true;
        if (null !== $this->id_depot) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . DepotTableMap::COL_ID_DEPOT . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(DepotTableMap::COL_ID_DEPOT)) {
            $modifiedColumns[':p' . $index++]  = 'id_depot';
        }
        if ($this->isColumnModified(DepotTableMap::COL_DEPOT_ADRESSE)) {
            $modifiedColumns[':p' . $index++]  = 'depot_adresse';
        }

        $sql = sprintf(
            'INSERT INTO depot (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_depot':
                        $stmt->bindValue($identifier, $this->id_depot, PDO::PARAM_INT);
                        break;
                    case 'depot_adresse':
                        $stmt->bindValue($identifier, $this->depot_adresse, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = DepotTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Depot'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Depot'][$this->hashCode()] = true;
        $keys = DepotTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIddepot(),
            $keys[1] => $this->getDepotAdresse(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIddepot($value);
                break;
            case 1:
                $this->setDepotAdresse($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIddepot($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setDepotAdresse($arr[$keys[1]]);
        }
    }
    ...
    {
        $criteria = new Criteria(DepotTableMap::DATABASE_NAME);

        if ($this->isColumnModified(DepotTableMap::COL_ID_DEPOT)) {
            $criteria->add(DepotTableMap::COL_ID_DEPOT, $this->id_depot);
        }
        if ($this->isColumnModified(DepotTableMap::COL_DEPOT_ADRESSE)) {
            $criteria->add(DepotTableMap::COL_DEPOT_ADRESSE, $this->depot_adresse);
        }
    ...
    {
        $criteria = ChildDepotQuery::create();
        $criteria->add(DepotTableMap::COL_ID_DEPOT, $this->id_depot);
    ...
    /**
     * Generic method to set the primary key (id_depot column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Depot (or compatible) type.
    ...
    {
        $copyObj->setDepotAdresse($this->getDepotAdresse());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIddepot(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Depot Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildDepot is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildDepot The current object (for fluent API support)
     */
    public function setDepotpartenaires(Collection $depotpartenaires, ConnectionInterface $con = null)
    {
        ...
        foreach ($depotpartenairesToDelete as $depotpartenaireRemoved) {
            $depotpartenaireRemoved->setDepot(null);
        }
     ...
     * Otherwise if this Depot is new, it will return
     * an empty collection; or if this Depot has previously
     * been saved, it will retrieve related Depotpartenaires from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Depot.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildDepotpartenaire[] List of ChildDepotpartenaire objects
     */
    public function getDepotpartenairesJoinPartenaire(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildDepotpartenaireQuery::create(null, $criteria);
    ...
    public function setStockdepots(Collection $stockdepots, ConnectionInterface $con = null)
    {
        ...
        foreach ($stockdepotsToDelete as $stockdepotRemoved) {
            $stockdepotRemoved->setDepot(null);
        }
    ...
    {
        return (string) $this->exportTo(DepotTableMap::DEFAULT_STRING_FORMAT);
    }
