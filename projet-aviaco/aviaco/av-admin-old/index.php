<?php
/*
class Gestionnaire_Session implements SessionHandlerInterface{
    public function close() {}
    public function destroy($session_id) {
        $id=$_SESSION['aviaco']['usr'];
        $user=EmployeQuery::create()->filterByEmail($id)->findOne();
        if($user){
            $user->setEtat(FALSE);
            return $user->save();
        }
 ...
 */
//$monHandle=new Gestionnaire_Session();
//session_set_save_handler($monHandle, true);
session_start();
?>
<!DOCTYPE html>
<!--
