...
/**
 * Base class that represents a row from the 'metier' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Metier implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MetierTableMap';
    ...
    /**
     * The value for the metier field.
     * @var        string
     */
    protected $metier;
    ...
    /**
     * Initializes internal state of Base\Metier object.
     */
    ...
    /**
     * Compares this with another <code>Metier</code> instance.  If
     * <code>obj</code> is an instance of <code>Metier</code>, delegates to
     * <code>equals(Metier)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Metier The current object, for fluid interface
     */
     ...
     * @return $this|\Metier The current object (for fluent API support)
     */
    public function setID($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MetierTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [metier] column.
     *
    ...
    public function setMetier($v)
    {
        ...
        if ($this->metier !== $v) {
            $this->metier = $v;
            $this->modifiedColumns[MetierTableMap::COL_METIER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MetierTableMap::translateFieldName('ID', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MetierTableMap::translateFieldName('Metier', TableMap::TYPE_PHPNAME, $indexType)];
            $this->metier = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = MetierTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Metier'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMetierQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Metier::setDeleted()
     * @see Metier::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMetierQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MetierTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[MetierTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . MetierTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(MetierTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(MetierTableMap::COL_METIER)) {
            $modifiedColumns[':p' . $index++]  = 'metier';
        }

        $sql = sprintf(
            'INSERT INTO metier (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'metier':
                        $stmt->bindValue($identifier, $this->metier, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = MetierTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Metier'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Metier'][$this->hashCode()] = true;
        $keys = MetierTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getID(),
            $keys[1] => $this->getMetier(),
        );
    ...
    {
        $criteria = new Criteria(MetierTableMap::DATABASE_NAME);

        if ($this->isColumnModified(MetierTableMap::COL_ID)) {
            $criteria->add(MetierTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MetierTableMap::COL_METIER)) {
            $criteria->add(MetierTableMap::COL_METIER, $this->metier);
        }
    ...
    {
        $criteria = ChildMetierQuery::create();
        $criteria->add(MetierTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Metier (or compatible) type.
    ...
    {
        $copyObj->setMetier($this->getMetier());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Metier Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildMetier is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMetier The current object (for fluent API support)
     */
    public function setSocietemetiers(Collection $societemetiers, ConnectionInterface $con = null)
    {
        ...
        foreach ($societemetiersToDelete as $societemetierRemoved) {
            $societemetierRemoved->setMetier(null);
        }
     ...
     * Otherwise if this Metier is new, it will return
     * an empty collection; or if this Metier has previously
     * been saved, it will retrieve related Societemetiers from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Metier.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildSocietemetier[] List of ChildSocietemetier objects
     */
    public function getSocietemetiersJoinSociete(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSocietemetierQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(MetierTableMap::DEFAULT_STRING_FORMAT);
    }
