...
/**
 * Base class that represents a row from the 'historique' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Historique implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\HistoriqueTableMap';
    ...
    /**
     * Initializes internal state of Base\Historique object.
     */
    ...
    /**
     * Compares this with another <code>Historique</code> instance.  If
     * <code>obj</code> is an instance of <code>Historique</code>, delegates to
     * <code>equals(Historique)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Historique The current object, for fluid interface
     */
     ...
     * @return $this|\Historique The current object (for fluent API support)
     */
    public function setID($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[HistoriqueTableMap::COL_ID] = true;
        }
    ...
    public function setHistorique($v)
    {
        ...
        if ($this->historique !== $v) {
            $this->historique = $v;
            $this->modifiedColumns[HistoriqueTableMap::COL_HISTORIQUE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : HistoriqueTableMap::translateFieldName('ID', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : HistoriqueTableMap::translateFieldName('Historique', TableMap::TYPE_PHPNAME, $indexType)];
            $this->historique = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = HistoriqueTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Historique'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildHistoriqueQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Historique::setDeleted()
     * @see Historique::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildHistoriqueQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HistoriqueTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[HistoriqueTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . HistoriqueTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(HistoriqueTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(HistoriqueTableMap::COL_HISTORIQUE)) {
            $modifiedColumns[':p' . $index++]  = 'historique';
        }

        $sql = sprintf(
            'INSERT INTO historique (%s) VALUES (%s)',
    ...
    {
        $pos = HistoriqueTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Historique'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Historique'][$this->hashCode()] = true;
        $keys = HistoriqueTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getID(),
            $keys[1] => $this->getHistorique(),
        );
    ...
    {
        $criteria = new Criteria(HistoriqueTableMap::DATABASE_NAME);

        if ($this->isColumnModified(HistoriqueTableMap::COL_ID)) {
            $criteria->add(HistoriqueTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(HistoriqueTableMap::COL_HISTORIQUE)) {
            $criteria->add(HistoriqueTableMap::COL_HISTORIQUE, $this->historique);
        }
    ...
    {
        $criteria = ChildHistoriqueQuery::create();
        $criteria->add(HistoriqueTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Historique (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Historique Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildHistorique is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildHistorique The current object (for fluent API support)
     */
    public function setSocietehistoriques(Collection $societehistoriques, ConnectionInterface $con = null)
    {
        ...
        foreach ($societehistoriquesToDelete as $societehistoriqueRemoved) {
            $societehistoriqueRemoved->setHistorique(null);
        }
    ...
    protected function doAddSocietehistorique(ChildSocietehistorique $societehistorique)
    {
        ...
        $societehistorique->setHistorique($this);
    }
    ...
    public function removeSocietehistorique(ChildSocietehistorique $societehistorique)
    {
        if ($this->getSocietehistoriques()->contains($societehistorique)) {
            ...
            $societehistorique->setHistorique(null);
        }
     ...
     * Otherwise if this Historique is new, it will return
     * an empty collection; or if this Historique has previously
     * been saved, it will retrieve related Societehistoriques from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Historique.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildSocietehistorique[] List of ChildSocietehistorique objects
     */
    public function getSocietehistoriquesJoinSociete(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSocietehistoriqueQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(HistoriqueTableMap::DEFAULT_STRING_FORMAT);
    }
