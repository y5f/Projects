...
abstract class Stock implements ActiveRecordInterface
{
    ...
    public function setIDPiece_FK($v)
    {
        ...
        if ($this->id_piece_fk !== $v) {
            $this->id_piece_fk = $v;
            $this->modifiedColumns[StockTableMap::COL_ID_PIECE_FK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : StockTableMap::translateFieldName('Datedepart', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_depart = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StockTableMap::translateFieldName('IDPiece_FK', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StockTableMap::COL_ID_PIECE_FK)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StockTableMap::COL_ID_PIECE_FK)) {
            $criteria->add(StockTableMap::COL_ID_PIECE_FK, $this->id_piece_fk);
        }
