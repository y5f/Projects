 ...
 *
 * @method     \SessionQuery|\CVQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EmployeQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'appliaviaco', $modelName = '\\Employe', $modelAlias = null)
    {
