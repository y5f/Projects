...
/**
 * Base class that represents a row from the 'cmd_app' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class CMDTAppareil implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CMDTAppareilTableMap';
    ...
    /**
     * Initializes internal state of Base\CMDTAppareil object.
     */
    ...
    /**
     * Compares this with another <code>CMDTAppareil</code> instance.  If
     * <code>obj</code> is an instance of <code>CMDTAppareil</code>, delegates to
     * <code>equals(CMDTAppareil)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CMDTAppareil The current object, for fluid interface
     */
     ...
     * @return $this|\CMDTAppareil The current object (for fluent API support)
     */
    public function setIdAp_FK($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->idap_fk !== $v) {
            $this->idap_fk = $v;
            $this->modifiedColumns[CMDTAppareilTableMap::COL_IDAP_FK] = true;
        }
    ...
    public function setIDCommande_FK($v)
    {
        ...
        if ($this->id_commande_fk !== $v) {
            ...
            $this->modifiedColumns[CMDTAppareilTableMap::COL_ID_COMMANDE_FK] = true;
        }
    ...
    public function setIDPiece_FK($v)
    {
        ...
        if ($this->id_piece_fk !== $v) {
            $this->id_piece_fk = $v;
            $this->modifiedColumns[CMDTAppareilTableMap::COL_ID_PIECE_FK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CMDTAppareilTableMap::translateFieldName('IdAp_FK', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idap_fk = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CMDTAppareilTableMap::translateFieldName('IDCommande_FK', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_commande_fk = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CMDTAppareilTableMap::translateFieldName('IDPiece_FK', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = CMDTAppareilTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CMDTAppareil'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCMDTAppareilQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CMDTAppareil::setDeleted()
     * @see CMDTAppareil::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCMDTAppareilQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CMDTAppareilTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CMDTAppareilTableMap::COL_IDAP_FK)) {
            $modifiedColumns[':p' . $index++]  = 'idAp_FK';
        }
        if ($this->isColumnModified(CMDTAppareilTableMap::COL_ID_COMMANDE_FK)) {
            $modifiedColumns[':p' . $index++]  = 'id_commande_FK';
        }
        if ($this->isColumnModified(CMDTAppareilTableMap::COL_ID_PIECE_FK)) {
            $modifiedColumns[':p' . $index++]  = 'id_piece_FK';
        }

        $sql = sprintf(
            'INSERT INTO cmd_app (%s) VALUES (%s)',
    ...
    {
        $pos = CMDTAppareilTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CMDTAppareil'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CMDTAppareil'][$this->hashCode()] = true;
        $keys = CMDTAppareilTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdAp_FK(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CMDTAppareilTableMap::COL_IDAP_FK)) {
            $criteria->add(CMDTAppareilTableMap::COL_IDAP_FK, $this->idap_fk);
        }
        if ($this->isColumnModified(CMDTAppareilTableMap::COL_ID_COMMANDE_FK)) {
            $criteria->add(CMDTAppareilTableMap::COL_ID_COMMANDE_FK, $this->id_commande_fk);
        }
        if ($this->isColumnModified(CMDTAppareilTableMap::COL_ID_PIECE_FK)) {
            $criteria->add(CMDTAppareilTableMap::COL_ID_PIECE_FK, $this->id_piece_fk);
        }
    ...
    {
        $criteria = ChildCMDTAppareilQuery::create();
        $criteria->add(CMDTAppareilTableMap::COL_IDAP_FK, $this->idap_fk);
        $criteria->add(CMDTAppareilTableMap::COL_ID_COMMANDE_FK, $this->id_commande_fk);
        $criteria->add(CMDTAppareilTableMap::COL_ID_PIECE_FK, $this->id_piece_fk);
    ...
    {
        $validPk = null !== $this->getIdAp_FK() &&
            null !== $this->getIDCommande_FK() &&
            null !== $this->getIDPiece_FK();

        $validPrimaryKeyFKs = 3;
        $primaryKeyFKs = [];

        //relation cmd_app_fk_5b99a8 to table commande
        ...
        //relation cmd_app_fk_c677b2 to table piece
        ...
        //relation cmd_app_fk_90f6ca to table appareil
        if ($this->aAppareil && $hash = spl_object_hash($this->aAppareil)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
    ...
    {
        $pks = array();
        $pks[0] = $this->getIdAp_FK();
        $pks[1] = $this->getIDCommande_FK();
    ...
    {
        $this->setIdAp_FK($keys[0]);
        $this->setIDCommande_FK($keys[1]);
    ...
    {
        return (null === $this->getIdAp_FK()) && (null === $this->getIDCommande_FK()) && (null === $this->getIDPiece_FK());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CMDTAppareil (or compatible) type.
    ...
    {
        $copyObj->setIdAp_FK($this->getIdAp_FK());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CMDTAppareil Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCommande(ConnectionInterface $con = null)
    {
        if ($this->aCommande === null && ($this->id_commande_fk !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommande->addCMDTAppareils($this);
             */
        }
    ...
    public function getPiece(ConnectionInterface $con = null)
    {
        if ($this->aPiece === null && ($this->id_piece_fk !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPiece->addCMDTAppareils($this);
             */
        }
    ...
    {
        if ($v === null) {
            $this->setIdAp_FK(NULL);
        } else {
            $this->setIdAp_FK($v->getIdAp());
        }
    ...
    public function getAppareil(ConnectionInterface $con = null)
    {
        if ($this->aAppareil === null && ($this->idap_fk !== null)) {
            $this->aAppareil = ChildAppareilQuery::create()
                ->filterByCMDTAppareil($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAppareil->addCMDTAppareils($this);
             */
        }
    ...
    {
        if (null !== $this->aCommande) {
            $this->aCommande->removeCMDTAppareil($this);
        }
        if (null !== $this->aPiece) {
            $this->aPiece->removeCMDTAppareil($this);
        }
        if (null !== $this->aAppareil) {
            $this->aAppareil->removeCMDTAppareil($this);
        }
        $this->idap_fk = null;
    ...
    {
        return (string) $this->exportTo(CMDTAppareilTableMap::DEFAULT_STRING_FORMAT);
    }
