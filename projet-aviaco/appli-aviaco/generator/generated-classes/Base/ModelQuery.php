 ...
 *
 * @method     \MarqueQuery|\AppareilQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class ModelQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'appliaviaco', $modelName = '\\Model', $modelAlias = null)
    {
