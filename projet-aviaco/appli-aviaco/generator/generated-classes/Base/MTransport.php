...
/**
 * Base class that represents a row from the 'transport' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class MTransport implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MTransportTableMap';
    ...
    /**
     * Initializes internal state of Base\MTransport object.
     */
    ...
    /**
     * Compares this with another <code>MTransport</code> instance.  If
     * <code>obj</code> is an instance of <code>MTransport</code>, delegates to
     * <code>equals(MTransport)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MTransport The current object, for fluid interface
     */
     ...
     * @return $this|\MTransport The current object (for fluent API support)
     */
    public function setMTransport($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->transport !== $v) {
            $this->transport = $v;
            $this->modifiedColumns[MTransportTableMap::COL_TRANSPORT] = true;
        }
    ...
    public function setCommentaire($v)
    {
        ...
        if ($this->commentaire !== $v) {
            $this->commentaire = $v;
            $this->modifiedColumns[MTransportTableMap::COL_COMMENTAIRE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MTransportTableMap::translateFieldName('MTransport', TableMap::TYPE_PHPNAME, $indexType)];
            $this->transport = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MTransportTableMap::translateFieldName('Commentaire', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = MTransportTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MTransport'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMTransportQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MTransport::setDeleted()
     * @see MTransport::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMTransportQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MTransportTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MTransportTableMap::COL_TRANSPORT)) {
            $modifiedColumns[':p' . $index++]  = 'transport';
        }
        if ($this->isColumnModified(MTransportTableMap::COL_COMMENTAIRE)) {
            $modifiedColumns[':p' . $index++]  = 'commentaire';
        }

        $sql = sprintf(
            'INSERT INTO transport (%s) VALUES (%s)',
    ...
    {
        $pos = MTransportTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MTransport'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MTransport'][$this->hashCode()] = true;
        $keys = MTransportTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getMTransport(),
    ...
    {
        $criteria = new Criteria(MTransportTableMap::DATABASE_NAME);

        if ($this->isColumnModified(MTransportTableMap::COL_TRANSPORT)) {
            $criteria->add(MTransportTableMap::COL_TRANSPORT, $this->transport);
        }
        if ($this->isColumnModified(MTransportTableMap::COL_COMMENTAIRE)) {
            $criteria->add(MTransportTableMap::COL_COMMENTAIRE, $this->commentaire);
        }
    ...
    {
        $criteria = ChildMTransportQuery::create();
        $criteria->add(MTransportTableMap::COL_TRANSPORT, $this->transport);
    ...
    {
        $validPk = null !== $this->getMTransport();
    ...
    /**
     * Generic method to set the primary key (transport column).
     *
    ...
    {
        return null === $this->getMTransport();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MTransport (or compatible) type.
    ...
    {
        $copyObj->setMTransport($this->getMTransport());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MTransport Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildMTransport is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMTransport The current object (for fluent API support)
     */
    public function setFournisseurs(Collection $fournisseurs, ConnectionInterface $con = null)
    {
        ...
        foreach ($fournisseursToDelete as $fournisseurRemoved) {
            $fournisseurRemoved->setMTransport(null);
        }
    ...
    protected function doAddFournisseur(ChildFournisseur $fournisseur)
    {
        ...
        $fournisseur->setMTransport($this);
    }
    ...
    public function removeFournisseur(ChildFournisseur $fournisseur)
    {
        if ($this->getFournisseurs()->contains($fournisseur)) {
            ...
            $fournisseur->setMTransport(null);
        }
     ...
     * Otherwise if this MTransport is new, it will return
     * an empty collection; or if this MTransport has previously
     * been saved, it will retrieve related Fournisseurs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in MTransport.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function setCommandes(Collection $commandes, ConnectionInterface $con = null)
    {
        ...
        foreach ($commandesToDelete as $commandeRemoved) {
            $commandeRemoved->setMTransport(null);
        }
     ...
     * @return ObjectCollection|ChildCommande[] List of ChildCommande objects
     */
    public function getCommandesJoinSociete(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCommandeQuery::create(null, $criteria);
        $query->joinWith('Societe', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(MTransportTableMap::DEFAULT_STRING_FORMAT);
    }
