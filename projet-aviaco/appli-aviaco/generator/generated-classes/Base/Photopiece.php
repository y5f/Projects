...
abstract class Photopiece implements ActiveRecordInterface
{
    ...
    public function setIDFRS_FK($v)
    {
        ...
        if ($this->id_fournisseur_fk !== $v) {
            ...
            $this->modifiedColumns[PhotopieceTableMap::COL_ID_FOURNISSEUR_FK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PhotopieceTableMap::translateFieldName('IDFRS_FK', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PhotopieceTableMap::COL_ID_FOURNISSEUR_FK)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PhotopieceTableMap::COL_ID_FOURNISSEUR_FK)) {
            $criteria->add(PhotopieceTableMap::COL_ID_FOURNISSEUR_FK, $this->id_fournisseur_fk);
        }
    ...
    public function getFournisseur(ConnectionInterface $con = null)
    {
        if ($this->aFournisseur === null && ($this->id_fournisseur_fk !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFournisseur->addPhotopieces($this);
             */
        }
    ...
    {
        if (null !== $this->aFournisseur) {
            $this->aFournisseur->removePhotopiece($this);
        }
        $this->id = null;
        $this->url_photo = null;
