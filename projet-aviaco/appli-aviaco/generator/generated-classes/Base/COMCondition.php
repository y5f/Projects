...
/**
 * Base class that represents a row from the 'commande_condition' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class COMCondition implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\COMConditionTableMap';
    ...
    /**
     * Initializes internal state of Base\COMCondition object.
     */
    ...
    /**
     * Compares this with another <code>COMCondition</code> instance.  If
     * <code>obj</code> is an instance of <code>COMCondition</code>, delegates to
     * <code>equals(COMCondition)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|COMCondition The current object, for fluid interface
     */
     ...
     * @return string
     */
    public function getCondition_FK()
    {
     ...
     * @return $this|\COMCondition The current object (for fluent API support)
     */
    public function setIDCommande_FK($v)
    {
        ...
        if ($this->id_commande_fk !== $v) {
            ...
            $this->modifiedColumns[COMConditionTableMap::COL_ID_COMMANDE_FK] = true;
        }
     ...
     * @return $this|\COMCondition The current object (for fluent API support)
     */
    public function setCondition_FK($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->condition_fk !== $v) {
            $this->condition_fk = $v;
            $this->modifiedColumns[COMConditionTableMap::COL_CONDITION_FK] = true;
        }
    ...
    public function setIDPiece_FK($v)
    {
        ...
        if ($this->id_piece_fk !== $v) {
            $this->id_piece_fk = $v;
            $this->modifiedColumns[COMConditionTableMap::COL_ID_PIECE_FK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : COMConditionTableMap::translateFieldName('IDCommande_FK', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_commande_fk = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : COMConditionTableMap::translateFieldName('Condition_FK', TableMap::TYPE_PHPNAME, $indexType)];
            $this->condition_fk = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : COMConditionTableMap::translateFieldName('IDPiece_FK', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = COMConditionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\COMCondition'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCOMConditionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see COMCondition::setDeleted()
     * @see COMCondition::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCOMConditionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                COMConditionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(COMConditionTableMap::COL_ID_COMMANDE_FK)) {
            $modifiedColumns[':p' . $index++]  = 'id_commande_FK';
        }
        if ($this->isColumnModified(COMConditionTableMap::COL_CONDITION_FK)) {
            $modifiedColumns[':p' . $index++]  = 'condition_FK';
        }
        if ($this->isColumnModified(COMConditionTableMap::COL_ID_PIECE_FK)) {
            $modifiedColumns[':p' . $index++]  = 'id_piece_FK';
        }

        $sql = sprintf(
            'INSERT INTO commande_condition (%s) VALUES (%s)',
    ...
    {
        $pos = COMConditionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['COMCondition'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['COMCondition'][$this->hashCode()] = true;
        $keys = COMConditionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIDCommande_FK(),
            $keys[1] => $this->getCondition_FK(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setCondition_FK($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(COMConditionTableMap::COL_ID_COMMANDE_FK)) {
            $criteria->add(COMConditionTableMap::COL_ID_COMMANDE_FK, $this->id_commande_fk);
        }
        if ($this->isColumnModified(COMConditionTableMap::COL_CONDITION_FK)) {
            $criteria->add(COMConditionTableMap::COL_CONDITION_FK, $this->condition_fk);
        }
        if ($this->isColumnModified(COMConditionTableMap::COL_ID_PIECE_FK)) {
            $criteria->add(COMConditionTableMap::COL_ID_PIECE_FK, $this->id_piece_fk);
        }
    ...
    {
        $criteria = ChildCOMConditionQuery::create();
        $criteria->add(COMConditionTableMap::COL_ID_COMMANDE_FK, $this->id_commande_fk);
        $criteria->add(COMConditionTableMap::COL_CONDITION_FK, $this->condition_fk);
        $criteria->add(COMConditionTableMap::COL_ID_PIECE_FK, $this->id_piece_fk);
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getIDCommande_FK() &&
            null !== $this->getCondition_FK() &&
            null !== $this->getIDPiece_FK();

        $validPrimaryKeyFKs = 3;
        $primaryKeyFKs = [];

        //relation commande_condition_fk_5b99a8 to table commande
        ...
        //relation commande_condition_fk_c677b2 to table piece
        ...
        //relation commande_condition_fk_0e9203 to table cond
        if ($this->aCondition && $hash = spl_object_hash($this->aCondition)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
    ...
    {
        return (null === $this->getIDCommande_FK()) && (null === $this->getCondition_FK()) && (null === $this->getIDPiece_FK());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \COMCondition (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCondition_FK($this->getCondition_FK());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \COMCondition Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCommande(ConnectionInterface $con = null)
    {
        if ($this->aCommande === null && ($this->id_commande_fk !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommande->addCOMConditions($this);
             */
        }
    ...
    public function getPiece(ConnectionInterface $con = null)
    {
        if ($this->aPiece === null && ($this->id_piece_fk !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPiece->addCOMConditions($this);
             */
        }
    ...
    {
        if ($v === null) {
            $this->setCondition_FK(NULL);
        } else {
            $this->setCondition_FK($v->getCondition());
        }
    ...
    public function getCondition(ConnectionInterface $con = null)
    {
        if ($this->aCondition === null && (($this->condition_fk !== "" && $this->condition_fk !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCondition->addCOMConditions($this);
             */
        }
    ...
    {
        if (null !== $this->aCommande) {
            $this->aCommande->removeCOMCondition($this);
        }
        if (null !== $this->aPiece) {
            $this->aPiece->removeCOMCondition($this);
        }
        if (null !== $this->aCondition) {
            $this->aCondition->removeCOMCondition($this);
        }
    ...
    {
        return (string) $this->exportTo(COMConditionTableMap::DEFAULT_STRING_FORMAT);
    }
