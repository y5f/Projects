...
class DocumentTableMap extends TableMap
{
    ...
    /**
     * the column name for the doc_name field
     */
    const COL_DOC_NAME = 'document.doc_name';

    /**
     * the column name for the id_fournisseur_FK field
     */
    const COL_ID_FOURNISSEUR_FK = 'document.id_fournisseur_FK';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Docnumber', 'Doc', 'NDoc', 'IDFRS_FK', 'DTESave_FK', ),
        self::TYPE_CAMELNAME     => array('docnumber', 'doc', 'nDoc', 'iDFRS_FK', 'dTESave_FK', ),
        self::TYPE_COLNAME       => array(DocumentTableMap::COL_DOC_NUM, DocumentTableMap::COL_DOC_LIEN, DocumentTableMap::COL_DOC_NAME, DocumentTableMap::COL_ID_FOURNISSEUR_FK, DocumentTableMap::COL_DATE_ENREG_FK, ),
        self::TYPE_FIELDNAME     => array('doc_num', 'doc_lien', 'doc_name', 'id_fournisseur_FK', 'date_enreg_FK', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Docnumber' => 0, 'Doc' => 1, 'NDoc' => 2, 'IDFRS_FK' => 3, 'DTESave_FK' => 4, ),
        self::TYPE_CAMELNAME     => array('docnumber' => 0, 'doc' => 1, 'nDoc' => 2, 'iDFRS_FK' => 3, 'dTESave_FK' => 4, ),
        self::TYPE_COLNAME       => array(DocumentTableMap::COL_DOC_NUM => 0, DocumentTableMap::COL_DOC_LIEN => 1, DocumentTableMap::COL_DOC_NAME => 2, DocumentTableMap::COL_ID_FOURNISSEUR_FK => 3, DocumentTableMap::COL_DATE_ENREG_FK => 4, ),
        self::TYPE_FIELDNAME     => array('doc_num' => 0, 'doc_lien' => 1, 'doc_name' => 2, 'id_fournisseur_FK' => 3, 'date_enreg_FK' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('doc_name', 'NDoc', 'VARCHAR', false, 100, null);
        $this->addForeignKey('id_fournisseur_FK', 'IDFRS_FK', 'INTEGER', 'fournisseur', 'id', false, null, null);
        $this->addColumn('date_enreg_FK', 'DTESave_FK', 'TIMESTAMP', false, null, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(DocumentTableMap::COL_DOC_NAME);
            $criteria->addSelectColumn(DocumentTableMap::COL_ID_FOURNISSEUR_FK);
            ...
            $criteria->addSelectColumn($alias . '.doc_name');
