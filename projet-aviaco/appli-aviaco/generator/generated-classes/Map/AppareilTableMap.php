...
class AppareilTableMap extends TableMap
{
     ...
     */
    const COL_IMMATRICULATION = 'appareil.Immatriculation';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdAp', 'Immatriculation', 'NomApp', 'Modele_PK', 'Marque_PK', ),
        self::TYPE_CAMELNAME     => array('idAp', 'immatriculation', 'nomApp', 'modele_PK', 'marque_PK', ),
        self::TYPE_COLNAME       => array(AppareilTableMap::COL_IDAP, AppareilTableMap::COL_IMMATRICULATION, AppareilTableMap::COL_NOM_APP, AppareilTableMap::COL_MODELE_PK, AppareilTableMap::COL_MARQUE_PK, ),
        self::TYPE_FIELDNAME     => array('idAp', 'Immatriculation', 'nom_app', 'modele_PK', 'marque_PK', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdAp' => 0, 'Immatriculation' => 1, 'NomApp' => 2, 'Modele_PK' => 3, 'Marque_PK' => 4, ),
        self::TYPE_CAMELNAME     => array('idAp' => 0, 'immatriculation' => 1, 'nomApp' => 2, 'modele_PK' => 3, 'marque_PK' => 4, ),
        self::TYPE_COLNAME       => array(AppareilTableMap::COL_IDAP => 0, AppareilTableMap::COL_IMMATRICULATION => 1, AppareilTableMap::COL_NOM_APP => 2, AppareilTableMap::COL_MODELE_PK => 3, AppareilTableMap::COL_MARQUE_PK => 4, ),
        self::TYPE_FIELDNAME     => array('idAp' => 0, 'Immatriculation' => 1, 'nom_app' => 2, 'modele_PK' => 3, 'marque_PK' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('idAp', 'IdAp', 'INTEGER', true, null, null);
  ...
  array (
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize(array((string) $obj->getIdAp(), (string) $obj->getModele_PK(), (string) $obj->getMarque_PK()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Appareil) {
                $key = serialize(array((string) $value->getIdAp(), (string) $value->getModele_PK(), (string) $value->getMarque_PK()));
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdAp', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 3 + $offset : static::translateFieldName('Modele_PK', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 4 + $offset : static::translateFieldName('Marque_PK', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return serialize(array((string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdAp', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 3 + $offset : static::translateFieldName('Modele_PK', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 4 + $offset : static::translateFieldName('Marque_PK', TableMap::TYPE_PHPNAME, $indexType)]));
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        $pks[] = (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('IdAp', TableMap::TYPE_PHPNAME, $indexType)
        ];
        $pks[] = (string) $row[
            $indexType == TableMap::TYPE_NUM
                ? 3 + $offset
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AppareilTableMap::COL_IMMATRICULATION);
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(AppareilTableMap::COL_IDAP, $value[0]);
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(AppareilTableMap::COL_IDAP) && $criteria->keyContainsValue(AppareilTableMap::COL_IDAP) ) {
