...
class ContactTableMap extends TableMap
{
     ...
     */
    const COL_FONCTION = 'contact.fonction';
     ...
     */
    const COL_MAIL = 'contact.mail';

    /**
     * the column name for the ordre field
     */
    const COL_ORDRE = 'contact.ordre';

    /**
     * the column name for the note field
     */
    const COL_NOTE = 'contact.note';

    /**
     * the column name for the societe_FK field
     */
    const COL_SOCIETE_FK = 'contact.societe_FK';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('ID', 'Nom', 'Fonction', 'Telephone', 'Mail', 'Ordre', 'Note', 'societe_FK', ),
        self::TYPE_CAMELNAME     => array('iD', 'nom', 'fonction', 'telephone', 'mail', 'ordre', 'note', 'societe_FK', ),
        self::TYPE_COLNAME       => array(ContactTableMap::COL_ID, ContactTableMap::COL_NOM, ContactTableMap::COL_FONCTION, ContactTableMap::COL_TELEPHONE, ContactTableMap::COL_MAIL, ContactTableMap::COL_ORDRE, ContactTableMap::COL_NOTE, ContactTableMap::COL_SOCIETE_FK, ),
        self::TYPE_FIELDNAME     => array('id', 'nom', 'fonction', 'telephone', 'mail', 'ordre', 'note', 'societe_FK', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('ID' => 0, 'Nom' => 1, 'Fonction' => 2, 'Telephone' => 3, 'Mail' => 4, 'Ordre' => 5, 'Note' => 6, 'societe_FK' => 7, ),
        self::TYPE_CAMELNAME     => array('iD' => 0, 'nom' => 1, 'fonction' => 2, 'telephone' => 3, 'mail' => 4, 'ordre' => 5, 'note' => 6, 'societe_FK' => 7, ),
        self::TYPE_COLNAME       => array(ContactTableMap::COL_ID => 0, ContactTableMap::COL_NOM => 1, ContactTableMap::COL_FONCTION => 2, ContactTableMap::COL_TELEPHONE => 3, ContactTableMap::COL_MAIL => 4, ContactTableMap::COL_ORDRE => 5, ContactTableMap::COL_NOTE => 6, ContactTableMap::COL_SOCIETE_FK => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'nom' => 1, 'fonction' => 2, 'telephone' => 3, 'mail' => 4, 'ordre' => 5, 'note' => 6, 'societe_FK' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('fonction', 'Fonction', 'VARCHAR', false, 80, null);
  ...
  array (
    ...
    1 => ':societe',
        ...
        $this->addRelation('FPartenaire', '\\FPartenaire', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id_contact',
    1 => ':id',
  ),
), 'CASCADE', 'CASCADE', 'FPartenaires', false);
    } // buildRelations()
    /**
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ContactTableMap::COL_FONCTION);
            $criteria->addSelectColumn(ContactTableMap::COL_TELEPHONE);
            $criteria->addSelectColumn(ContactTableMap::COL_MAIL);
            $criteria->addSelectColumn(ContactTableMap::COL_ORDRE);
            $criteria->addSelectColumn(ContactTableMap::COL_NOTE);
            $criteria->addSelectColumn(ContactTableMap::COL_SOCIETE_FK);
        } else {
