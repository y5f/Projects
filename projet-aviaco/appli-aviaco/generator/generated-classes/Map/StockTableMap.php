...
class StockTableMap extends TableMap
{
     ...
     */
    const COL_ID_PIECE_FK = 'stock.id_piece_FK';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id_stock', 'Datedepart', 'IDPiece_FK', ),
        self::TYPE_CAMELNAME     => array('id_stock', 'datedepart', 'iDPiece_FK', ),
        self::TYPE_COLNAME       => array(StockTableMap::COL_STOCK_ID, StockTableMap::COL_DATE_DEPART, StockTableMap::COL_ID_PIECE_FK, ),
        self::TYPE_FIELDNAME     => array('stock_id', 'date_depart', 'id_piece_FK', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id_stock' => 0, 'Datedepart' => 1, 'IDPiece_FK' => 2, ),
        self::TYPE_CAMELNAME     => array('id_stock' => 0, 'datedepart' => 1, 'iDPiece_FK' => 2, ),
        self::TYPE_COLNAME       => array(StockTableMap::COL_STOCK_ID => 0, StockTableMap::COL_DATE_DEPART => 1, StockTableMap::COL_ID_PIECE_FK => 2, ),
        self::TYPE_FIELDNAME     => array('stock_id' => 0, 'date_depart' => 1, 'id_piece_FK' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(StockTableMap::COL_ID_PIECE_FK);
        } else {
