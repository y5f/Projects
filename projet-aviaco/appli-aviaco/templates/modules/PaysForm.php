...
class PaysForm extends Template{
    function __construct() {
        ...
        $p=new P();
        $lab=new Label('lab');
        $lab->addElement(new Text('Selctionnez un pays :'));
        $input=new Select();
        $input->setAttribute('id','select-pays');
        $input->addElement(new Text('<option value="France" selected="selected">France </option>
...
<option value="Zimbabwe">Zimbabwe </option>'));
        ...
        $but->setAttribute('class','but-pays');
